...
party = {'gen': "java -Xmx3500m -Xms3500m -cp bin/:../FlexSC/lib/*:../FlexSC/bin util.GenRunnable",
'eva':"java -Xmx3500m -Xms3500m -cp bin/:../FlexSC/lib/*:../FlexSC/bin util.EvaRunnable"}
