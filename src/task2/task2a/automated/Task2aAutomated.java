...
public class Task2aAutomated<t__T> implements IWritable<Task2aAutomated<t__T>, t__T> {

	public CompEnv<t__T> env;
	public IntegerLib<t__T> intLib;
	public FloatLib<t__T> floatLib;

	public Task2aAutomated(CompEnv<t__T> env) throws Exception {
		this.env = env;
	...
	public Task2aAutomated<t__T> newObj(t__T[] data) throws Exception {
		if(data == null) {
			data = env.newTArray(this.numBits());
			for(int i=0; i<this.numBits(); ++i) { data[i] = intLib.SIGNAL_ZERO; }
		}
		if(data.length != this.numBits()) return null;
		Task2aAutomated<t__T> ret = new Task2aAutomated<t__T>(env);
		t__T[] tmp;
		int now = 0;
		return ret;
}
	...
	public t__T[] countOnes(int n, t__T[] x) throws Exception {
		...
		Pair<t__T, bit<t__T>, Int<t__T>> f_tmp_23 = this.add((n)-((n)/(2)), __tmp29, __tmp30);
	...
	public t__T[] leadingZero(int n, t__T[] x) throws Exception {
		...
		int f_tmp_32 = 2;
		int __tmp42 = f_tmp_32;
		int f_tmp_33 = n - __tmp42;
		int __tmp43 = f_tmp_33;
		i = __tmp43;
		int f_tmp_34 = 0;
		int __tmp44 = f_tmp_34;
		boolean f_tmp_35 = i >= __tmp44;
		boolean __tmp45 = f_tmp_35;
		while(__tmp45) {
			t__T __tmp46 = y[(i)+(1)];
			t__T __tmp47 = y[(i)+(1)];
			t__T __tmp48 = x[i];
			t__T f_tmp_36 = intLib.xor(__tmp47,__tmp48);
			t__T __tmp49 = f_tmp_36;
			t__T f_tmp_37 = intLib.and(__tmp46,__tmp49);
			t__T __tmp50 = f_tmp_37;
			y[i]=__tmp50;
			int f_tmp_38 = 1;
			int __tmp51 = f_tmp_38;
			int f_tmp_39 = i - __tmp51;
			int __tmp52 = f_tmp_39;
			i = __tmp52;
			int f_tmp_40 = 0;
			__tmp44 = f_tmp_40;
			boolean f_tmp_41 = i >= __tmp44;
			__tmp45 = f_tmp_41;
		}
		t__T[] f_tmp_42 = this.countOnes(n, y);
		t__T[] __tmp53 = f_tmp_42;
		return __tmp53;
