...
\end{framed}
Alice and Bob each hold a list of record, where each record is of the format $(pos, val)$.

\paragraph{Our solution.}
Each party constructs a set containing all the elements in the list: $S^a$ for Alice and $S^b$ for Bob.
