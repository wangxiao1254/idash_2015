...
The two parties first compute the frequency of two types of alleles their own lists and get
...
where $r = a + b, s = c + d, g = a + c, k = b + d, n =  r + s$; where $a, b$ are the frequency of two types of alleles in
$l_{case} = l^A_{case} || l^B_{case}$ and $c, d$ are the frequency of two types of alleles in
